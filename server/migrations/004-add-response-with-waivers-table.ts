...
export class TestMigration1740453404021 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE TYPE "public"."Response_formtype_enum" AS ENUM(\'APPLICATION\', \'LIABILITY_WAIVER\', \'PHOTO_RELEASE\')');
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('CREATE TYPE "public"."Response_formtype_enum_old" AS ENUM(\'APPLICATION\')');
